        ...
        >
                ...
                return (
                  <Pressable
                    ...
                    className={`px-4 py-3 rounded-xl min-w-[70px] items-center ${
                      isSelected ? "bg-wise-primary" : "bg-wise-card"
                    }`}
          ...
          <View className="px-4 mb-4">
            <View className="flex-row items-center mb-4">
              <IconSymbol name="chart.bar" size={20} color={WiseColors.primary} />
              <Text className="font-archivo-bold text-xl text-wise-text ml-2">
                Weekly Overview
              </Text>
            </View>
          </View>
